...
# 4) Abrir watcher de Tailwind en una nueva terminal
Start-Process powershell -ArgumentList "cd 'C:\Users\Carlos Fuentes\ProyectosCIMCO\frontend'; npm run watch:css" -WindowStyle Normal
